...
export const TemplatesHubPage = () => {
    ...
    const [tab, setTab] = useState(availableTabs[0] ?? 'inspection');
    ...
    return (<Stack spacing={2}>
      <PageHero title="Template Library" description="Manage inspection and closeout templates for consistent execution across projects and disciplines." badges={<Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap>
