...
type StatTone = 'primary' | 'secondary' | 'success' | 'warning' | 'neutral'

const toneStyles: Record<StatTone, { bar: string; glow: string }> = {
...
export const StatCard = ({ label, value, hint, icon, tone = 'primary' }: StatCardProps) => {
  ...
  return (
    ...
    >
      <Stack spacing={0.8}>
        ...
        {hint && (
          <Typography variant="body2" color="text.secondary" sx={{ backgroundColor: style.glow, px: 1, py: 0.4, borderRadius: 1.5 }}>
            {hint}
          </Typography>
        )}
      </Stack>
