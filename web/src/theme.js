...
export const createAppTheme = (direction) => createTheme({
    direction,
    palette: {
        mode: 'light',
        primary: {
    ...
    components: {
        MuiCssBaseline: {
            styleOverrides: {
                body: {
                    background: 'radial-gradient(circle at 8% -4%, rgba(36, 72, 143, 0.13) 0%, rgba(36, 72, 143, 0) 44%), radial-gradient(circle at 96% 0%, rgba(122, 147, 61, 0.12) 0%, rgba(122, 147, 61, 0) 40%), linear-gradient(180deg, #F7FAFF 0%, #EEF3FA 100%)',
                },
            },
        },
        MuiPaper: {
