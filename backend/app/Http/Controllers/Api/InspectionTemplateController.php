...
class InspectionTemplateController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $template = InspectionTemplate::query()->create([
            ...
            'observation_fields' => $validated['observation_fields'] ?? null,
    ...
    public function update(Request $request, InspectionTemplate $inspectionTemplate): JsonResponse
    {
        ...
        $inspectionTemplate->fill([
            ...
            'observation_fields' => array_key_exists('observation_fields', $validated) ? $validated['observation_fields'] : $inspectionTemplate->observation_fields,
    ...
    private function validatePayload(Request $request, bool $partial = false): array
    {
        ...
        return $request->validate([
            ...
            // BR-FR-037 / OD-08: admin-definable optional observation fields.
            'observation_fields' => [$prefix.'nullable', 'array'],
            'observation_fields.*.key' => ['required_with:observation_fields', 'string', 'max:120'],
            'observation_fields.*.label' => ['required_with:observation_fields', 'string', 'max:255'],
            'observation_fields.*.type' => ['required_with:observation_fields', 'in:text,textarea,number,select,date,checkbox'],
            'observation_fields.*.required' => ['sometimes', 'boolean'],
            'observation_fields.*.options' => ['nullable', 'array'],
    ...
    public function cloneFromLibrary(Request $request, InspectionTemplate $inspectionTemplate): JsonResponse
    {
        ...
        $clone = InspectionTemplate::query()->create([
            ...
            'observation_fields' => $inspectionTemplate->observation_fields,
